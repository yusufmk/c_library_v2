...
#define MAVLINK_MSG_ID_ATTITUDE_LEN 29
#define MAVLINK_MSG_ID_ATTITUDE_MIN_LEN 29
#define MAVLINK_MSG_ID_30_LEN 29
#define MAVLINK_MSG_ID_30_MIN_LEN 29

#define MAVLINK_MSG_ID_ATTITUDE_CRC 52
#define MAVLINK_MSG_ID_30_CRC 52
...
#define MAVLINK_MESSAGE_INFO_ATTITUDE { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_attitude_t, time_boot_ms) }, \
         { "attitude_id", NULL, MAVLINK_TYPE_UINT8_T, 0, 28, offsetof(mavlink_attitude_t, attitude_id) }, \
...
{
    return mavlink_msg_attitude_pack(system_id, component_id, msg, attitude->time_boot_ms, attitude->attitude_id, attitude->roll, attitude->pitch, attitude->yaw, attitude->rollspeed, attitude->pitchspeed, attitude->yawspeed);
}
...
{
    return mavlink_msg_attitude_pack_chan(system_id, component_id, chan, msg, attitude->time_boot_ms, attitude->attitude_id, attitude->roll, attitude->pitch, attitude->yaw, attitude->rollspeed, attitude->pitchspeed, attitude->yawspeed);
}
...
static inline void mavlink_msg_attitude_send(mavlink_channel_t chan, uint32_t time_boot_ms, uint8_t attitude_id, float roll, float pitch, float yaw, float rollspeed, float pitchspeed, float yawspeed)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_ATTITUDE_LEN];
    _mav_put_uint32_t(buf, 0, time_boot_ms);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_attitude_send(chan, attitude->time_boot_ms, attitude->attitude_id, attitude->roll, attitude->pitch, attitude->yaw, attitude->rollspeed, attitude->pitchspeed, attitude->yawspeed);
#else
 ...
 */
static inline void mavlink_msg_attitude_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t time_boot_ms, uint8_t attitude_id, float roll, float pitch, float yaw, float rollspeed, float pitchspeed, float yawspeed)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field attitude_id from attitude message
 *
 * @return  Attitude source id, 1:EKF2, 2=INSP, 3=Other FCS
 */
static inline uint8_t mavlink_msg_attitude_get_attitude_id(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_attitude_decode(const mavlink_message_t* msg, mavlink_attitude_t* attitude)
{
    ...
    attitude->attitude_id = mavlink_msg_attitude_get_attitude_id(msg);
#else
