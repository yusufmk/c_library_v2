...
#define MAVLINK_MSG_ID_GLOBAL_POSITION_INT_LEN 29
#define MAVLINK_MSG_ID_GLOBAL_POSITION_INT_MIN_LEN 29
#define MAVLINK_MSG_ID_33_LEN 29
#define MAVLINK_MSG_ID_33_MIN_LEN 29

#define MAVLINK_MSG_ID_GLOBAL_POSITION_INT_CRC 45
#define MAVLINK_MSG_ID_33_CRC 45
...
#define MAVLINK_MESSAGE_INFO_GLOBAL_POSITION_INT { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_global_position_int_t, time_boot_ms) }, \
         { "gpos_id", NULL, MAVLINK_TYPE_UINT8_T, 0, 28, offsetof(mavlink_global_position_int_t, gpos_id) }, \
...
{
    return mavlink_msg_global_position_int_pack(system_id, component_id, msg, global_position_int->time_boot_ms, global_position_int->gpos_id, global_position_int->lat, global_position_int->lon, global_position_int->alt, global_position_int->relative_alt, global_position_int->vx, global_position_int->vy, global_position_int->vz, global_position_int->hdg);
}
...
static inline void mavlink_msg_global_position_int_send(mavlink_channel_t chan, uint32_t time_boot_ms, uint8_t gpos_id, int32_t lat, int32_t lon, int32_t alt, int32_t relative_alt, int16_t vx, int16_t vy, int16_t vz, uint16_t hdg)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_GLOBAL_POSITION_INT_LEN];
    _mav_put_uint32_t(buf, 0, time_boot_ms);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_global_position_int_send(chan, global_position_int->time_boot_ms, global_position_int->gpos_id, global_position_int->lat, global_position_int->lon, global_position_int->alt, global_position_int->relative_alt, global_position_int->vx, global_position_int->vy, global_position_int->vz, global_position_int->hdg);
#else
 ...
 */
static inline void mavlink_msg_global_position_int_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t time_boot_ms, uint8_t gpos_id, int32_t lat, int32_t lon, int32_t alt, int32_t relative_alt, int16_t vx, int16_t vy, int16_t vz, uint16_t hdg)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field gpos_id from global_position_int message
 *
 * @return  global position source id, 1:EKF2, 2=INSP, 3=Other FCS 
 */
static inline uint8_t mavlink_msg_global_position_int_get_gpos_id(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_global_position_int_decode(const mavlink_message_t* msg, mavlink_global_position_int_t* global_position_int)
{
    ...
    global_position_int->gpos_id = mavlink_msg_global_position_int_get_gpos_id(msg);
#else
