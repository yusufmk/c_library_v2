...
#define MAVLINK_MSG_ID_ATTITUDE2_LEN 28
#define MAVLINK_MSG_ID_ATTITUDE2_MIN_LEN 28
#define MAVLINK_MSG_ID_13001_LEN 28
#define MAVLINK_MSG_ID_13001_MIN_LEN 28

#define MAVLINK_MSG_ID_ATTITUDE2_CRC 146
#define MAVLINK_MSG_ID_13001_CRC 146
...
{
    return mavlink_msg_attitude2_pack(system_id, component_id, msg, attitude2->time_boot_ms, attitude2->roll, attitude2->pitch, attitude2->yaw, attitude2->rollspeed, attitude2->pitchspeed, attitude2->yawspeed);
}
...
{
    return mavlink_msg_attitude2_pack_chan(system_id, component_id, chan, msg, attitude2->time_boot_ms, attitude2->roll, attitude2->pitch, attitude2->yaw, attitude2->rollspeed, attitude2->pitchspeed, attitude2->yawspeed);
}
...
static inline void mavlink_msg_attitude2_send(mavlink_channel_t chan, uint32_t time_boot_ms, float roll, float pitch, float yaw, float rollspeed, float pitchspeed, float yawspeed)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_ATTITUDE2_LEN];
    _mav_put_uint32_t(buf, 0, time_boot_ms);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_attitude2_send(chan, attitude2->time_boot_ms, attitude2->roll, attitude2->pitch, attitude2->yaw, attitude2->rollspeed, attitude2->pitchspeed, attitude2->yawspeed);
#else
 ...
 */
static inline void mavlink_msg_attitude2_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t time_boot_ms, float roll, float pitch, float yaw, float rollspeed, float pitchspeed, float yawspeed)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
